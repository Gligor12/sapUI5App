		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sapUI5App",
									"targetURL": "#opensapsapui5app-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opensapsapui5app-display": {
								"semanticObject": "opensapsapui5app",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opensap.sapui5app",
									"url": sap.ui.require.toUrl("opensap/sapui5app")
								}
							}
						}
					}
